$(document).ready(function(){function a(){return new Promise(a=>{$(".footer-container").append(`
...
`);$('[data-toggle="tooltip"]').tooltip();a()})}function t(){setInterval(()=>{let a=new Date;let t=a.toLocaleString("en-US",{weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:true});$("#yearData").text(t)},1e3)}a().then(t)});